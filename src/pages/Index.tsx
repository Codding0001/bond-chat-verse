            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Chat with friends instantly with reactions & replies</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Send virtual gifts with coin sound effects</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">High-quality calls with notifications</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Record and send voice notes with playback speed control</p>
                </div>
              </div>
            </div>
          </CardContent>
